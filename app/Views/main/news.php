        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">GTN NEWS</h1>
                    <a href="<?=base_url()?>" class="btn btn-primary py-md-3 px-md-5 me-3">Live</a>
                    <a href="https://www.youtube.com/@gtntv2318" class="btn btn-secondary py-md-3 px-md-5">Watch News</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-primary p-4">
                        <div class="d-flex overflow-hidden mb-3">
                            ...
                            <a href="" class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Breaking News
                            </a>
                        </div>
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0" src="img/blog-2.jpg" style="width: 75px;" alt="">
                            <a href="" class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Broadcast
                            </a>
                        </div>
                        <div class="d-flex overflow-hidden mb-3">
                            <img class="img-fluid flex-shrink-0" src="img/blog-3.jpg" style="width: 75px;" alt="">
                            <a href="" class="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Sports
                            </a>
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="d-flex flex-wrap m-n1">
                        <a href="" class="btn btn-primary m-1">News</a>
                        <a href="" class="btn btn-primary m-1">Talents</a>
                        <a href="" class="btn btn-primary m-1">Sports</a>
                        <a href="" class="btn btn-primary m-1">Music</a>
                        <a href="" class="btn btn-primary m-1">Production</a>
